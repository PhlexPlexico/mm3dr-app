...
extern string_view fastHMSDesc;
extern string_view fastMikauDesc;
extern string_view fastDarmaniDesc;
extern string_view fastMaskDesc;
extern string_view fastOcarinaDesc;
extern string_view fastArrowDesc;
